...
def run_game():
    ...
    # Bird and pipe init
    bird_img = pygame.image.load("physio_app//static//assets//img\Games//bird_sprite.png")
    ...
    pipe_frames = deque()
    pipe_img = pygame.image.load("physio_app//static//assets//img\Games//pipe_sprite_single.png")
    ...
    with mp_face_mesh.FaceMesh(
        ...
        while True:
            ...
            if pipeSpawnTimer == 0:
                ...
                # Assuming space_between_pipes is a positive value
                lower_limit = 120 - 1000
                upper_limit = max(lower_limit + 1, window_size[1] - 140 - space_between_pipes - 800)
